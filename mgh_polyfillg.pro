...
;      Written
;    Fixed bug with nout - Loren Anderson March 2011
;-
...
; Removed these - I have no idea what they did, they aren't used in the
; remainder of the program, and nout caused errors
;      nout = n0*n1
;      dout = dimension
